...
var Zepto = (function () {
  ...
  return (
    ($.matches = function (t, e) {
      ...
      return (
        ...
        ((n =
          ...
          t.matchesSelector)
          ? n.call(t, e)
          : ((r = !(n = t.parentNode)) && (n = V).appendChild(t),
            (n = ~$.qsa(n, e).indexOf(t)),
            r && V.removeChild(t),
            n))
      );
    ...
    ($.fragment = function (t, e, n) {
      var r, i, o;
      return (
        (r = R.test(t) ? b(N.createElement(RegExp.$1)) : r) ||
          (t.replace && (t = t.replace(k, "<$1></$2>")),
          e === y && (e = P.test(t) && RegExp.$1),
          ((o = Z[(e = e in Z ? e : "*")]).innerHTML = "" + t),
    ...
    ($.init = function (t, e) {
      ...
      if ("string" == typeof t)
        if ("<" == (t = t.trim())[0] && P.test(t))
          (n = $.fragment(t, RegExp.$1, e)), (t = null);
        else {
        ...
        if (D(t))
          ...
          (n = $.fragment(t.trim(), RegExp.$1, e)), (t = null);
        else {
          if (e !== y) return b(e).find(t);
          n = $.qsa(N, t);
        }
        ...
        return r
          ? this.each(function (t) {
              var e = b(this),
                ...
                t = { top: t.top - n.top, left: t.left - n.left };
          ...
          ? {
              left:
                (t = this[0].getBoundingClientRect()).left + window.pageXOffset,
      ...
      css: function (t, e) {
        if (arguments.length < 2) {
          ...
          if (((n = getComputedStyle(i, "")), "string" == typeof t))
            return i.style[E(t)] || n.getPropertyValue(t);
          if (D(t))
            return (
              (r = {}),
      ...
      position: function () {
        ...
        if (this.length)
          return (
            ...
            (e = this.offsetParent()),
            (n = this.offset()),
            (r = A.test(e[0].nodeName) ? { top: 0, left: 0 } : e.offset()),
      ...
      offsetParent: function () {
        return this.map(function () {
          for (
            ...
            t && !A.test(t.nodeName) && "static" == b(t).css("position");
        ...
        (n.proxy = function (t) {
          ...
          if (!(t = v(t)).isImmediatePropagationStopped())
            return (
              (t.data = o),
              !1 ===
                (e = r.apply(i, t._args == x ? [t] : [t].concat(t._args))) &&
    ...
    var x,
      ...
      s =
        ...
        (l.proxy = function (t, e) {
          var n,
            r = 2 in arguments && b.call(arguments, 2);
          if (w(t))
            return (
              ((n = function () {
          ...
          if (y(e))
            return r
              ? (r.unshift(t[e], t), l.proxy.apply(null, r))
              : l.proxy(t[e], t);
  ...
  (function (f) {
    ...
    function a(t, e, n) {
      ...
      n.complete.call(r, e, t),
        ...
        (t = n).global && !--f.active && h(t, null, "ajaxStop");
    }
    function v() {}
    function g(t, e) {
    ...
    function s(t, e, n, r) {
      return (
        f.isFunction(e) && ((r = n), (n = e), (e = void 0)),
        f.isFunction(n) || ((r = n), (n = void 0)),
    ...
    var y,
      ...
      r =
        ...
        (f.active = 0),
        (f.ajaxJSONP = function (n, r) {
          var i, o, t, a, s, u, e, c;
          return "type" in n
            ? ((t = n.jsonpCallback),
              (a = (f.isFunction(t) ? t() : t) || "jsonp" + ++l),
              ...
              r && r.promise(c),
              f(s).on("load error", function (t, e) {
                clearTimeout(o),
                  f(s).off().remove(),
                  "error" != t.type && i
                    ? d(i[0], c, n, r)
                    : m(null, e || "error", c, n, r),
                  (window[a] = u),
                  i && f.isFunction(u) && u(i[0]),
                  (u = i = void 0);
              }),
              !1 === p(c, n)
                ? e("abort")
        ...
        (f.ajax = function (t) {
          ...
          for (y in f.ajaxSettings)
            void 0 === n[y] && (n[y] = f.ajaxSettings[y]);
          (e = n).global && 0 == f.active++ && h(e, null, "ajaxStart"),
            n.crossDomain ||
              (((e = b.createElement("a")).href = n.url),
              (e.href = e.href),
              (n.crossDomain =
                C.protocol + "//" + C.host != e.protocol + "//" + e.host)),
            n.url || (n.url = window.location.toString()),
            (e = n).processData &&
              e.data &&
              "string" != f.type(e.data) &&
          ...
          if (
            (r && r.promise(c),
            n.crossDomain || o("X-Requested-With", "XMLHttpRequest"),
            o("Accept", t || "*/*"),
            (t = n.mimeType || t) &&
              (-1 < t.indexOf(",") && (t = t.split(",", 2)[0]),
              c.overrideMimeType && c.overrideMimeType(t)),
            (n.contentType ||
              (!1 !== n.contentType &&
                n.data &&
          ...
          if (
              ...
              if (4 == c.readyState) {
                ...
                if (
                  ...
                  (i =
                    i ||
                    ((t =
                      (t = n.mimeType || c.getResponseHeader("content-type")) &&
                      t.split(";", 2)[0]) &&
                      (t == S
                        ? "html"
                        : t == j
                  ...
                  try {
                    "script" == i
                      ...
                      : "xml" == i
                      ? (t = c.responseXML)
                      : "json" == i && (t = T.test(t) ? null : f.parseJSON(t));
                  } catch (t) {
                    e = t;
                  }
            ...
            c.abort(), m(null, "abort", c, n, r);
          else {
            if (n.xhrFields) for (x in n.xhrFields) c[x] = n.xhrFields[x];
            e = !("async" in n) || n.async;
            for (x in (c.open(n.type, n.url, e, n.username, n.password), s))
              l.apply(c, s[x]);
            0 < n.timeout &&
              (a = setTimeout(function () {
                (c.onreadystatechange = v),
                  c.abort(),
                  m(null, "timeout", c, n, r);
              }, n.timeout)),
              c.send(n.data || null);
          }
          return c;
        ...
        (f.fn.load = function (t, e, n) {
          ...
          return (
            this.length &&
              ...
              (t = s(t, e, n)),
              (a = t.success),
              1 < o.length && ((t.url = o[0]), (r = o[1])),
              (t.success = function (t) {
                i.html(r ? f("<div>").html(t.replace(u, "")).find(r) : t),
            ...
            l.keyup(function (e) {
              ...
              c(this).val().length
                ? ((n = c(this).val()),
                  ...
                  (t = l),
                  r(),
                  i.append(c(s.searchResultsTitle)),
                  t.length
                    ? c.each(t, function (e, t) {
                        if (e < s.limit) {
                          for (var n = s.template, e = 0; e < a.length; e++)
                            var l = new RegExp("{" + a[e] + "}", "g"),
                              n = n.replace(l, t[a[e]]);
                          i.append(c(n));
                        }
                      })
                    : i.append(s.noResults))
                : r();
            });
        },
  ...
  function (m) {
      ...
      for (
        ...
        for (r in a)
          Object.prototype.hasOwnProperty.call(a, r) &&
            (t && "[object Object]" === Object.prototype.toString.call(a[r])
              ? (e[r] = g(!0, e[r], a[r]))
              : (e[r] = a[r]));
      }
      return e;
    ...
    function t(e) {
      ...
      t &&
        ...
        (e.preventDefault(), a.animateScroll(t, t.hash, o));
    }
    function n(e) {
      r =
        r ||
    ...
    a.animateScroll = function (r, a, e) {
      function t() {
        var e, t, n;
        (c = 1 < (c = (h += 16) / parseInt(i.speed, 10)) ? 1 : c),
          (c =
            s +
            f *
              ((e = i.easing),
              ...
              (n =
                "easeInOutQuint" === e
                  ? t < 0.5
                    ...
                    : 1 + 16 * --t * t * t * t * t
                  : n) || t)),
          m.scrollTo(0, Math.floor(c)),
          p(c, l, o);
      }
      var o,
        c,
        n =
          (n = r ? r.getAttribute("data-options") : null) &&
          "object" == typeof JSON &&
        ...
        s = m.pageYOffset,
        l =
          ((v = v || m.document.querySelector(i.selectorHeader)),
          (y = y || b(v)),
          (function (e, t, n) {
            var o = 0;
            if (e.offsetParent)
        ...
        p =
          ...
          function (e, t, n) {
            var o = m.pageYOffset;
            (e == t || o == t || m.innerHeight + o >= d) &&
              (clearInterval(n), u.focus(), i.callback(r, a));
          });
    ...
    return (
      (a.destroy = function () {
        o &&
          ...
          m.removeEventListener("resize", n, !1),
          (y = v = r = o = null));
      }),
      (a.init = function (e) {
        c &&
          (a.destroy(),
          (o = g(O, e || {})),
          (v = m.document.querySelector(o.selectorHeader)),
          (y = b(v)),
          m.document.addEventListener("click", t, !1),
          v && m.addEventListener("resize", n, !1));
      }),
      a
    );
  }
      ...
      (m.style.bottom = o < i && l ? "0%" : "-100%"),
        i <= s
          ? ((t = (100 * (r = i / s)).toFixed(2)),
            ...
            (n = parseInt(r * t)),
            (r = parseInt(n / 60)),
            (e = parseInt(60 * (n / 60 - r))),
            (t = t - n),
            (n = parseInt(t / 60)),
            (t = parseInt(60 * (t / 60 - n))),
            (n = n < 10 ? "0" + n : n),
            (t = t < 10 ? "0" + t : t),
            (d.innerText =
              (r = r < 10 ? "0" + r : r) + ":" + (e = e < 10 ? "0" + e : e)),
            (u.innerText = n + ":" + t),
            (l = !0),
          ...
          : ((c.style.width = "100%"),
            (a.style.width = "0%"),
            (e =
              (e = parseInt(m.getAttribute("data-minutes"))) < 10
                ? "0" + e
                : e),
            (d.innerText = "00:00"),
            (u.innerText = e + ":00"),
